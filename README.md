...
> It's a leaderboard populated by an API. Use only JavaScript, Webpack & CSS was used to build this.
...
- display scores in real time from API
...
```sh
  git clone git@github.com:danutibe07/leaderboard.git
```
